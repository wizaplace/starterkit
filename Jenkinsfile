pipeline {
    ...
    post {
        failure {
            ...
            emailext subject: "Failed: ${env.JOB_NAME} - ${env.BUILD_DISPLAY_NAME}", attachLog: true, recipientProviders: [[$class: 'CulpritsRecipientProvider']], body: '''${SCRIPT, template="groovy-html.template"}'''
        }
    }
    environment {
